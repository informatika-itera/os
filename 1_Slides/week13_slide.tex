...
\begin{frame}
    ...
    \begin{block}{Jawaban Singkat}
        \begin{enumerate}
            \item Owner bisa baca+tulis; group dan others tidak bisa apa-apa.
...
%--- Slide 3: Mekanisme Proteksi OS ---
\begin{frame}[shrink=5]
    \frametitle{Mekanisme Proteksi oleh OS}
    \framesubtitle{Bagaimana OS melindungi diri dari malware}
...
\begin{frame}[shrink=15]
    ...
    \begin{center}
        \begin{tikzpicture}[scale=0.65, transform shape]
            % VM side
            \node[draw, fill=blue!15, rounded corners=3pt, minimum width=5cm, minimum height=0.5cm] (vm_host) at (-4, 2.5) {{\small Host OS}};
            \node[draw, fill=orange!25, rounded corners=3pt, minimum width=4.5cm, minimum height=0.4cm] (vm_hyper) at (-4, 1.7) {{\small Hypervisor}};
            \node[draw, fill=green!20, rounded corners=3pt, minimum width=2.5cm, minimum height=0.6cm] (vm1_os) at (-5.5, 0.5) {{\small Guest OS}};
            \node[draw, fill=green!20, rounded corners=3pt, minimum width=2.5cm, minimum height=0.6cm] (vm2_os) at (-2.5, 0.5) {{\small Guest OS}};
            \node[draw, fill=yellow!25, rounded corners=3pt, minimum width=1.8cm, minimum height=0.3cm] (vm1_app) at (-5.5, -0.3) {{\tiny App A}};
            \node[draw, fill=yellow!25, rounded corners=3pt, minimum width=1.8cm, minimum height=0.3cm] (vm2_app) at (-2.5, -0.3) {{\tiny App B}};

            \node[align=center] at (-4, -1.3) {{\bf VM}: Masing-masing\\punya OS sendiri.\\Berat, boot lama.};

            % Container side
            \node[draw, fill=blue!15, rounded corners=3pt, minimum width=5cm, minimum height=0.5cm] (cont_os) at (4, 2.5) {{\small Host OS}};
            \node[draw, fill=red!15, rounded corners=3pt, minimum width=5cm, minimum height=0.4cm] (cont_engine) at (4, 1.7) {{\small Container Engine}};
            \node[draw, fill=yellow!25, rounded corners=3pt, minimum width=2.5cm, minimum height=0.6cm] (c1) at (2.5, 0.5) {{\small Container 1}};
            \node[draw, fill=yellow!25, rounded corners=3pt, minimum width=2.5cm, minimum height=0.6cm] (c2) at (5.5, 0.5) {{\small Container 2}};
            \node[draw, fill=green!10, rounded corners=3pt, minimum width=2cm, minimum height=0.3cm] (c1_libs) at (2.5, -0.3) {{\tiny Lib v1}};
            \node[draw, fill=green!10, rounded corners=3pt, minimum width=2cm, minimum height=0.3cm] (c2_libs) at (5.5, -0.3) {{\tiny Lib v2}};

            \node[align=center] at (4, -1.3) {{\bf Container}: Pakai kernel\\host bersama. Ringan,\\start cepat.};

            \node[align=center, font=\bf] at (-4, 3.2) {Virtual Machine};
            \node[align=center, font=\bf] at (4, 3.2) {Container};
        \end{tikzpicture}
    \end{center}
\end{frame}
...
%--- Slide 2: RAID 0 ---
\begin{frame}[shrink=10]
    \frametitle{RAID 0: Striping}
    \framesubtitle{Kecepatan tanpa redundansi}
    ...
    \begin{columns}[T]
        ...
        \vspace{0.15cm}
        \begin{exampleblock}{Ilustrasi: File ``BUKU''}
            \small
            \texttt{Disk 1: B K U} \\
            \texttt{Disk 2: U U $\emptyset$} \\
            \texttt{Pembacaan paralel: lebih cepat!}
        \end{exampleblock}
...
%--- Slide 3: RAID 1 ---
\begin{frame}[shrink=10]
    \frametitle{RAID 1: Mirroring}
    \framesubtitle{Aman tapi boros}
    ...
    \begin{columns}[T]
        ...
        \begin{exampleblock}{Ilustrasi: File ``BUKU''}
            \small
            \texttt{Disk 1: B U K U} \\
            \texttt{Disk 2: B U K U} \\
            \texttt{Identik!}
        \end{exampleblock}
...
%--- Slide 4: RAID 5 & 6 ---
\begin{frame}[shrink=5]
    \frametitle{RAID 5 \& 6: Parity}
    \framesubtitle{Keseimbangan antara performa, kapasitas, dan keamanan}
    ...
    \begin{exampleblock}{Analogi: Permainan Teka-Teki}
        \small
        Parity seperti teka-teki silang: jika satu kotak hilang, kita masih bisa menebak isinya dari petunjuk baris dan kolom yang lain. RAID 6 memberi dua petunjuk, jadi dua kotak hilang pun masih tertebak.
    \end{exampleblock}
\end{frame}
...
\begin{frame}[shrink=5]
    ...
    \begin{center}
        ...
        \begin{tabular}{p{0.20\textwidth}p{0.17\textwidth}p{0.17\textwidth}p{0.17\textwidth}p{0.17\textwidth}}
            ...
            Redundansi & Tidak ada & Salinan penuh & Parity (1 disk) & Parity ganda (2 disk) \\
