...
\begin{enumerate}
    ...
    \item 1 dokumen ringkas (PDF 1--2 halaman) berisi poin solusi, tabel hasil hitung, kesimpulan, serta mencantumkan tautan video sebagai backup.
\end{enumerate}
...
\begin{itemize}
    ...
    \item Pengumpulan dilakukan melalui Lectura (kolom paste link hanya satu).
    \item Tempel link laporan PDF dan link video pada kolom yang sama, lalu pisahkan masing-masing link dengan \textit{line break} (Enter).
